...
q0 = [0,-2,deg2rad(90+40)];
q1 = [-4, 0, deg2rad(-90-90)];
...
phi1 = q0(3) + pi/2 - theta
phi2 = psi - theta
phi3 = 3*pi/2 + psi - q1(3)

phi1 = mod(phi1, 2*pi);
phi2 = mod(phi2, 2*pi);
phi3 = mod(phi3, 2*pi);

path = Dubins.from_word(q0, 'RLR', [cmax, -phi1, cmax, phi2, cmax, -phi3]);
...
%%
rlr = Dubins.find_rlr(q0, q1, cmax);
[p2, length2] = Dubins.find_parameters_CCC(q0, q1, cmax, false);
